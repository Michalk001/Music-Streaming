        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdString = table.Column<string>(nullable: true),
                    Name = table.Column<string>(nullable: true),
                    SongFileId = table.Column<Guid>(nullable: true),
                    AlbumId = table.Column<Guid>(nullable: true),
                    Length = table.Column<double>(nullable: false),
                    UploadUserId = table.Column<Guid>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Songs_AspNetUsers_UploadUserId",
